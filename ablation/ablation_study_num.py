...
DATASETS = [
    ("preprocessed_Hall_num.csv", "Hall"),
    ("preprocessed_Kitchenham_num.csv", "Kitchenham"),
    ("preprocessed_Wahono_num.csv", "Wahono"),
    ("preprocessed_Radjenovic_num.csv", "Radjenovic"),
]
...
# Write summary CSV
summary_csv = "ablation_summary_num.csv"
...
def plot_all_metrics():
    ...
    for dataset_file, dataset_name in DATASETS:
        ...
        plt.suptitle(f"Ablation Study Comparison on {dataset_name} (NUM)")
        plt.tight_layout(rect=[0, 0.03, 1, 0.95])
        outname = f"ablation_{dataset_name}_num.png"
        plt.savefig(outname)
